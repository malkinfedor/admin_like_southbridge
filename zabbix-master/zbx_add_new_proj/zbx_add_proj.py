...
parser.add_argument('--prname', required=True, action='store', default=None, dest='proj', help='Project name in redmine. For example: slurm.io')
            ...
            user = zapi.user.create(
                {
                    ...
                    "usrgrps": [
                        {
                            "usrgrpid":usergroup['usrgrpids'][0]
                        }
                    ]
